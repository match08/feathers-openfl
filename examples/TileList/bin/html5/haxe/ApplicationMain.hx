...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("TileList", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("TileList", null, 960, 640);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "TileList";
		app.meta["name"] = "TileList";
	...
	macro public static function getEntryPoint()
	{
		...
		switch (Context.follow(Context.getType("TileList")))
		{
			case TInst(t, params):
				...
				if (hasMain)
				{
					return Context.parse("@:privateAccess TileList.main()", Context.currentPos());
				}
				...
				{
					Context.fatalError("Main class \"TileList\" has neither a static main nor a constructor.", Context.currentPos());
				}

			default:

				Context.fatalError("Main class \"TileList\" isn't a class.", Context.currentPos());
		}
...
@:keep @:dox(hide) class DocumentClass extends TileList {}
#else
class DocumentClass
{
