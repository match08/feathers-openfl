...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("ComponentsExplorer", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("ComponentsExplorer", null, 960, 640);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "ComponentsExplorer";
		app.meta["name"] = "ComponentsExplorer";
		app.meta["packageName"] = "feathers.examples";
	...
	macro public static function getEntryPoint()
	{
		...
		switch (Context.follow(Context.getType("ComponentsExplorer")))
		{
			case TInst(t, params):
				...
				if (hasMain)
				{
					return Context.parse("@:privateAccess ComponentsExplorer.main()", Context.currentPos());
				}
				...
				{
					Context.fatalError("Main class \"ComponentsExplorer\" has neither a static main nor a constructor.", Context.currentPos());
				}

			default:

				Context.fatalError("Main class \"ComponentsExplorer\" isn't a class.", Context.currentPos());
		}
...
@:keep @:dox(hide) class DocumentClass extends ComponentsExplorer {}
#else
class DocumentClass
{
