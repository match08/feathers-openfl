...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Gallery", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Gallery", null, 960, 640);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Gallery";
		app.meta["name"] = "Gallery";
	...
	macro public static function getEntryPoint()
	{
		...
		switch (Context.follow(Context.getType("Gallery")))
		{
			case TInst(t, params):
				...
				if (hasMain)
				{
					return Context.parse("@:privateAccess Gallery.main()", Context.currentPos());
				}
				...
				{
					Context.fatalError("Main class \"Gallery\" has neither a static main nor a constructor.", Context.currentPos());
				}

			default:

				Context.fatalError("Main class \"Gallery\" isn't a class.", Context.currentPos());
		}
...
@:keep @:dox(hide) class DocumentClass extends Gallery {}
#else
class DocumentClass
{
