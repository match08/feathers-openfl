...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("LayoutExplorer", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("LayoutExplorer", null, 960, 640);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "LayoutExplorer";
		app.meta["name"] = "LayoutExplorer";
	...
	macro public static function getEntryPoint()
	{
		...
		switch (Context.follow(Context.getType("LayoutExplorer")))
		{
			case TInst(t, params):
				...
				if (hasMain)
				{
					return Context.parse("@:privateAccess LayoutExplorer.main()", Context.currentPos());
				}
				...
				{
					Context.fatalError("Main class \"LayoutExplorer\" has neither a static main nor a constructor.", Context.currentPos());
				}

			default:

				Context.fatalError("Main class \"LayoutExplorer\" isn't a class.", Context.currentPos());
		}
...
@:keep @:dox(hide) class DocumentClass extends LayoutExplorer {}
#else
class DocumentClass
{
